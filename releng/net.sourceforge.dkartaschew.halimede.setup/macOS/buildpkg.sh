...
_JRE="OpenJDK11U-jre_x64_mac_hotspot_11.0.5_10.tar.gz"
_URL="https://github.com/AdoptOpenJDK/openjdk11-binaries/releases/download/jdk-11.0.5%2B10/OpenJDK11U-jre_x64_mac_hotspot_11.0.5_10.tar.gz"
_JRE_FOLDER="jdk-11.0.5+10-jre"
_BUILD=`date '+%Y%m%d'`
