...
public class TestIssuedCertificateColumnComparator {

	@Test
	public void columnInvalid() {
		IssuedCertificateComparator comp = new IssuedCertificateComparator();
	...
	public void columnDescription() {
		...
		final int idx = IssuedCertificatesPane.COLUMN_DESCRIPTION;
	...
	public void columnSubject() {
		...
		final int idx = IssuedCertificatesPane.COLUMN_SUBJECT;
	...
	public void columnKeyType() {
		...
		final int idx = IssuedCertificatesPane.COLUMN_KEY_TYPE;
	...
	public void columnIssueDate() {
		...
		final int idx = IssuedCertificatesPane.COLUMN_ISSUE_DATE;
	...
	public void columnStartDate() {
		...
		final int idx = IssuedCertificatesPane.COLUMN_START_DATE;
		ZonedDateTime now = ZonedDateTime.now();
	...
	public void columnExpiryDate() {
		...
		final int idx = IssuedCertificatesPane.COLUMN_EXPIRY_DATE;
		ZonedDateTime now = ZonedDateTime.now();
	...
	public void columnComment() {
		...
		final int idx = IssuedCertificatesPane.COLUMN_COMMENTS;
